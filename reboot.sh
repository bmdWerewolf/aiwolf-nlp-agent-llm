...
uv pip install fastapi uvicorn vllm openai langchain jinja2 pydantic python-dotenv langchain-openai nest_asyncio python-ulid websocket-client langchain-google-genai langchain_ollama langchain-openai langchain-anthropic langchain-community numpy pandas ulid-transform
echo "--------------------------------------------------"
